...
activities = {
    ...
    "Swimming Club": {
        "description": "Build swimming skills with lap sessions and water games",
        "schedule": "Wednesdays and Fridays, 3:00 PM - 4:30 PM",
        "max_participants": 18,
        "participants": ["jason@mergington.edu", "riley@mergington.edu"]
    },
    "Art Workshop": {
        "description": "Explore drawing, painting, and mixed media art projects",
        "schedule": "Mondays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["maria@mergington.edu", "nina@mergington.edu"]
    },
    "Drama Club": {
        "description": "Practice acting, stagecraft, and prepare performances",
        "schedule": "Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 20,
        "participants": ["josh@mergington.edu", "maya@mergington.edu"]
    },
    "Math Olympiad": {
